...
export default {
  ...
  methods:{
    bannerOneClick(){
      let obj = {type: this.backgroundArr[this.index].previewData?this.backgroundArr[this.index].previewData.type:'color', color: this.backgroundArr[this.index].previewData?this.backgroundArr[this.index].previewData.color:this.rgb}
