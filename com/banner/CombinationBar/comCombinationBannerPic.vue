...
export default {
  ...
  methods:{
    ...
    bannerOneClick(){
      let obj = {type: this.backgroundArr[this.index].previewData?this.backgroundArr[this.index].previewData.type:'img', poster: this.backgroundArr[this.index].previewData?this.backgroundArr[this.index].previewData.poster:this.url}
